...
-sums all repetitions after phase and frequency correction using “sum_rep.m” which in turn uses the 
...
-/!\ be sure to update the paths to the directory containing the raw FIDs as well as to the folder 
where data is saved in “Process_sig_DDE.m”
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
2/LCModel analysis:
-the .CONTROL file for one FID summarizes all the LCModel fitting parameters 
-the .RAW and .PLOTIN files for the LCModel basis set are stored in the zip folder 
“basis_SE_DDE_30_25”
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
